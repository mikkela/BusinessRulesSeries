...
{
    public class OrBusinessRuleExpressionTest
    {
        ...
        public void two_parts_that_both_evaluates_to_true_gives_a_true()
        {
            ...
            var target = new OrBusinessRuleExpression(new[] { part1, part2 });
        ...
        [Fact]
        public void two_parts_first_is_true_second_is_false_evaluates_to_true_gives_a_true()
        {
            var part1 = PartHelper.CreatePart(true, rule1);
        ...
        [Fact]
        public void two_parts_first_is_false_second_is_true_gives_a_true()
        {
        ...
        [Fact]
        public void two_parts_with_overlapping_facts_are_only_represented_once()
        {
