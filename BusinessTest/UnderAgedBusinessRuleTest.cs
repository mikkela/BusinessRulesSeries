...
{
    public class UnderAgedBusinessRuleTest : TestBase
    {
        [Theory]
        [PropertyData("UnderAge")]
        public void Evaluates_to_true_for_under_aged_people(int age)
        {
            Assert.True(new UnderAgedBusinessRule(age).Evaluate());
        }
        ...
        {
            Assert.False(new UnderAgedBusinessRule(age).Evaluate());
        }
